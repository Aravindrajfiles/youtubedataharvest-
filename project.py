...
image = Image.open('youtube.jpeg')
st.image(image)
st.title (":green[Youtube Data Harvesting]") 

#---------------------------------------------#

api_key = "AIzaSyBABuBwGSFf8uQXifBsBndNjTfDyRXgXOA"
...
def create_tables():
    ...
    mydb = pymysql.connect(
        ...
        password="root",
        autocommit=True)
    connection = pymysql.connect(host="127.0.0.1", port=3306, user='root', password='root', database='project youtube')
...
if choice=="About Me":
    st.write('This project is done by Aravind Raj')
    URL="https://www.linkedin.com/in/aravind-raj-069800280"
